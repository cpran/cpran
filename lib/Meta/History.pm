...
use strict;
use warnings;
package CPrAN::Meta::History;

our $VERSION = '2.150006';

1;

# ABSTRACT: history of CPrAN Meta Spec changes

=head1 DESCRIPTION

The CPrAN Meta Spec has gone through several iterations.  It was
...
This document reconstructs the history of the CPrAN Meta Spec based on
...
CPrAN-Meta distribution and will be published on CPrAN as
L<CPrAN::Meta::Spec>.

Going forward, specification version numbers will be integers and
decimal portions will correspond to a release date for the CPrAN::Meta
library.
...
CPrAN Meta Spec used for metadata
