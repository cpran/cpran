...
use strict;
use warnings;
package CPrAN::Meta::Spec;

our $VERSION = '2.150006';

1;

# ABSTRACT: specification for CPrAN distribution metadata
...
=head1 SYNOPSIS
  ...
  my $distmeta = {
    ...
    'meta-spec' => {
      version => '2',
      url     => 'https://metacpan.org/pod/CPrAN::Meta::Spec',
    },
...
This document describes version 2 of the CPrAN distribution metadata
specification, also known as the "CPrAN Meta Spec".

Revisions of this specification for typo corrections and prose
clarifications may be issued as CPrAN::Meta::Spec 2.I<x>.  These
...
dual-life modules that exist on CPrAN as well as in the Perl core).  This
...
Example:
  ...
  'meta-spec' => {
    version => '2',
    url     => 'http://search.cpan.org/perldoc?CPrAN::Meta::Spec',
  }

(Spec 1.2) [required] {Map}

This field indicates the version of the CPrAN Meta Spec that should be
...
This subkey gives the integer I<Version> of the CPrAN Meta Spec against
...
=for :list
* C<https://metacpan.org/pod/CPrAN::Meta::Spec>
* C<http://search.cpan.org/perldoc?CPrAN::Meta::Spec>
...
distribution for CPrAN or other repositories in addition to or in
...
PAUSE, CPrAN, metacpan.org and search.cpan.org to build indexes saying in
...
Example:
  ...
  resources => {
    ...
    bugtracker  => {
      web    => 'http://rt.cpan.org/Public/Dist/Display.html?Name=CPrAN-Meta',
...
CPrAN.  When a module is deleted from a distribution, prerequisites calling
...
For example, as of Oct 31, 2009, the CPrAN index file contained these
...
the contents of lib/, but there are many fascinating oddities on CPrAN and
...
Ken Williams wrote the original CPrAN Meta Spec (also known as the
