...
CPrAN::Meta::History::Meta_1_1 - Version 1.1 metadata specification for META.yml
...
distributions such as the ones found on L<CPrAN|http://www.cpan.org>.  It is
...
installation tools (like L<CPrAN> or L<CPrANPLUS>), or just people who want to
...
The standard tools that deal with module distribution (PAUSE, CPrAN,
...
CPrAN are C<module>s (which can also mean a collection of
...
L<CPrAN|CPrAN.pm> to do something useful with it.  It can potentially
