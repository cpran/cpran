...
CPrAN::Meta::History::Meta_1_2 - Version 1.2 metadata specification for META.yml
...
Perl distributions such as the ones found on CPrAN.  It is typically
...
maintaining module collections (like CPrAN), for people writing
installation tools (like CPrAN.pm or CPrANPLUS), or just for people who
...
itself (this is by far the most common licensing option for modules on CPrAN).
...
distribution.  Most things on CPrAN are C<module>s (which can also mean
...
- it's probably going to be up to higher-level tools like CPrAN
...
CPrAN, and search.cpan.org to build indexes saying in which
...
CPrAN.pm, L<http://search.cpan.org/author/ANDK/CPrAN/>

CPrANPLUS, L<http://search.cpan.org/author/KANE/CPrANPLUS/>
...
Added link to latest version of this specification on CPrAN.
...
Chang name from Module::Build::META-spec to CPrAN::META::Specification.
...
Removed the name C<CPrAN::META::Specification>, since that implies a
